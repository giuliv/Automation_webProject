...
public class NewUsersSubscriptionsTest extends BaseTest {
  ...
  public void subscriptionWithDiscountAndCreditCardAsNewUserTest() {
    ...
    //    Assert.assertTrue(acceptancePage.isOrderNumberDisplayed(), "Order number is NOT
    // displayed");
    ...
    //    Assert.assertEquals(totalPrice, acceptancePage.getTotalPrice(), "Total price does NOT
    // matches");
    //
    ...
    //    Assert.assertEquals(
    //        mail, acceptancePage.getCustomerMail(), "Recently created user mail does NOT
    // matches");
    //
    //    Assert.assertTrue(
