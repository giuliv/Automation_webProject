...
public class TeaAllTeaTests extends BaseTest {
  ...
  public void teaItemsTest() {
    ...
    logger.info("5. Click on 'Quick view'");
    QuickViewComponent quickViewComponent = itemComponent.clickQuickView();

    logger.info("6. Validate the user is shown with 'Add to cart' button");
    softAssert.assertNotNull(
        quickViewComponent.isAddToCartButtonDisplayed(), "'Add to cart' button isn't displayed");
