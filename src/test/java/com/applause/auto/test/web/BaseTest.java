...
public class BaseTest extends BaseSeleniumTest {
	...
	public void beforeMethod(Method method) {
		...
		// Maximize the browser for mobile web platforms
		if(EnvironmentHelper.isAndroidMobileWeb(DriverManager.getDriver()) || EnvironmentHelper.isIOSMobileWeb(DriverManager.getDriver())) {
	...
	protected LandingPage navigateToLandingPage() {
		...
		return ComponentFactory.create(LandingPage.class);
	}
