...
public class MiniCartTest extends BaseTest {
  ...
  public void removeReAddMiniCartTest() {
    ...
    Assert.assertTrue(
        items.contains(TestData.COFFEE_BRAND_NAME),
        "Product not found: " + TestData.COFFEE_BRAND_NAME);
    Assert.assertTrue(
        items.contains(TestData.COFFEE_ARABIAN_MOCHA_JAVA_NAME),
    ...
    Assert.assertEquals(
        miniCartContainer.getReAddButtonCaption(TestData.COFFEE_BRAND_NAME),
        "re-add item",
    ...
    Assert.assertEquals(
        miniCartContainer.getRemoveButtonCaption(TestData.COFFEE_BRAND_NAME),
        "remove",
