...
public class CreateAccountTest extends BaseTest {
	...
	@Test(groups = { TestNGGroups.ONBOARDING }, description = "625879")
	...
	@Test(groups = { TestNGGroups.ONBOARDING }, description = "625883")
	public void signInEmailPasswordTest() {
		...
		Assert.assertTrue(!signInView.getPassword().equals(TestData.PASSWORD),
		...
		Assert.assertEquals(signInView.getUnEncryptedPassword(), MyAccountTestData.PASSWORD,
	...
	@Test(groups = { TestNGGroups.ONBOARDING }, description = "625925")
	...
	@Test(groups = { TestNGGroups.ONBOARDING }, description = "625927")
	...
	@Test(groups = { TestNGGroups.ONBOARDING }, description = "625926")
	...
	@Test(groups = { TestNGGroups.ONBOARDING }, description = "625880")
	...
	@Test(groups = { TestNGGroups.ONBOARDING }, description = "625929")
