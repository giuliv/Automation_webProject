...
public class PeetsCardsTest extends BaseTest {
	...
	public void transferBalanceFromPhysicalCardDigitalCardWithNoBalance() {
		...
		softAssert.assertTrue(peetsCardsTransferAmountWarningChunk.getFormattedMessage().contains(MobileTestData.TRANSFER_ERROR), "Wrong warning message displayed");
		...
		softAssert.assertTrue(peetsCardsTransferAmountWarningChunk.getFormattedMessageCouldNotProcess().contains(MobileTestData.TRANSFER_PROCESS_ERROR), "Wrong process message displayed");
