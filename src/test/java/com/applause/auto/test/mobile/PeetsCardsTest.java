...
public class PeetsCardsTest extends BaseTest {
	...
	public void addValueToNewDigitalCard25SavedCC() throws ParseException {
		...
		paymentMethodsView = testHelper.deletePaymentMethodTestCardIfAdded(paymentMethodsView, CC_MASTER_NAME);
	...
	@Test(groups = { TestNGGroups.PEETS_CARDS, TestNGGroups.DAILY, TestNGGroups.REGRESSION }, description = "1292900")
	...
	@Test(groups = { TestNGGroups.PEETS_CARDS, TestNGGroups.DAILY, TestNGGroups.REGRESSION }, description = "1959019")
