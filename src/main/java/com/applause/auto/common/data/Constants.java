...
public class Constants {
	...
	public static final class TestData {
		public static final String LANDING_PAGE_URL = TestEnvironment.valueOf(WebHelper.getTestEnvironment())
				.getEnvironment();
		...
		public static final String SHOP_COFFEE_KCUPS_PAGE_URL = LANDING_PAGE_URL.concat("/coffee/k-cups");
