...
public class CoffeeStoreContainerChuck extends BaseComponent {
  ...
  @Locate(
      xpath =
          "((//XCUIElementTypeButton[@name=\"Order\" or @name=\"Reorder\"])[1]/../../XCUIElementTypeOther[1]/XCUIElementTypeStaticText[1])|((//XCUIElementTypeTable[@visible='true']/XCUIElementTypeCell/XCUIElementTypeButton[@name=\"Order\" or @name=\"Rerder\"])[1]/../XCUIElementTypeStaticText[2])",
      on = Platform.MOBILE_IOS)
  @Locate(
      xpath =
          "//*[contains(@resource-id, 'com.wearehathway.peets.development:id/storeDetail') and descendant::*[contains(@resource-id,'storeDetailContainer')]]"
