...
public class CoffeeStoreContainerChuck extends BaseComponent {
  ...
  @Locate(
      xpath =
          "(//XCUIElementTypeNavigationBar[@name=\"ORDER\"])[1]/following-sibling::XCUIElementTypeOther//XCUIElementTypeStaticText[@value='Pickup at:'])[1]/following-sibling::XCUIElementTypeStaticText[contains(@name,'%s')]",
      on = Platform.MOBILE_IOS)
  @Locate(
      xpath =
