...
public class LandingView extends BaseComponent {
	...
	public CreateAccountView createAccount() {
		...
		getSyncHelper().wait(Until.uiElement(getCreateAccountButton).clickable().setTimeout(Duration.ofSeconds(20)));
	...
	public void skipOnboarding() {
		...
		// view
		try {
			getSyncHelper().wait(Until.uiElement(getSkipButton).clickable().setTimeout(Duration.ofSeconds(20)));
			getSkipButton.click();
	...
	public void skipOnboarding() {
		...
		try {
			...
			if (!getCreateAccountButton.exists()) {
				...
				getSyncHelper().wait(Until.uiElement(getStartedButton).clickable().setTimeout(Duration.ofSeconds(20)));
