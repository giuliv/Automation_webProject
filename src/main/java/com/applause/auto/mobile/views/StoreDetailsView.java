...
public class StoreDetailsView extends BaseComponent {
	...
	@Locate(xpath = "(//XCUIElementTypeMap/../../following-sibling::XCUIElementTypeOther)[1]/XCUIElementTypeStaticText", on = Platform.MOBILE_IOS)
	...
	@Locate(xpath = "//XCUIElementTypeButton[@name='Unmark as favorite Coffeebar'] | //XCUIElementTypeButton[@name='Mark as favorite Coffeebar']", on = Platform.MOBILE_IOS)
	...
	@Locate(xpath = "(//XCUIElementTypeMap/../../following-sibling::XCUIElementTypeOther)[2]/XCUIElementTypeStaticText[1]", on = Platform.MOBILE_IOS)
	...
	@Locate(xpath = "//XCUIElementTypeStaticText[starts-with(@name,'Open until ')]", on = Platform.MOBILE_IOS)
	@Locate(xpath = "(//android.widget.TextView[@text='HOURS']/following-sibling::android.widget.TextView)[1]", on = Platform.MOBILE_ANDROID)
	...
	public boolean isCoffeebarFavorite() {
		...
		int colourRed = MobileHelper.getMobileElementColour(coffeebarFavoriteIcon.getMobileElement()).getRed();
