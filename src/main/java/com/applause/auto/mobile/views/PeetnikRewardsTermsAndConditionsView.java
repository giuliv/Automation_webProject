...
@Implementation(is = AndroidPeetnikRewardsTermsAndConditionsView.class, on = Platform.MOBILE_ANDROID)
...
public class PeetnikRewardsTermsAndConditionsView extends BaseComponent {
	...
	@Locate(xpath = "//XCUIElementTypeStaticText[@name=\"PEETNIK REWARDS TERMS & CONDITIONS\"]", on = Platform.MOBILE_IOS)
	@Locate(xpath = "(//*[contains(@text, \"PEETNIK REWARDS TERMS & CONDITIONS\")])[2]", on = Platform.MOBILE_ANDROID)
	...
	@Locate(xpath = "//android.widget.Button[@text='Allow only while using the app']", on = Platform.MOBILE_ANDROID)
