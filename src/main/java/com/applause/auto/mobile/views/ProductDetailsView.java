...
public class ProductDetailsView extends BaseComponent {
	...
	@Locate(xpath = "//android.widget.Button[@resource-id='com.wearehathway.peets.development:id/modifierButton' and @text='%s']", on = Platform.MOBILE_ANDROID)
	@Locate(iOSClassChain = "**/XCUIElementTypeStaticText[`label == \"%s\"`]", on = Platform.MOBILE_IOS)
	protected Button sizeButton;

	@Locate(xpath = "//android.widget.TextView[starts-with(@text,'Milk Prep') or starts-with(@text,'Milk')]", on = Platform.MOBILE_ANDROID)
	@Locate(iOSClassChain = "**/XCUIElementTypeStaticText[`label == \"Milk Prep\" OR label == \"Milk\"`]", on = Platform.MOBILE_IOS)
	protected Button selectMilkPrepButton;

	@Locate(xpath = "//android.widget.TextView[starts-with(@text,'Syrups & Sauces')]", on = Platform.MOBILE_ANDROID)
	@Locate(iOSClassChain = "**/XCUIElementTypeStaticText[`label CONTAINS \"Syrups & Sauces\"`]", on = Platform.MOBILE_IOS)
	protected Button selectSyrupsAndSaucesButton;

	@Locate(id = "com.wearehathway.peets.development:id/productCostTextView", on = Platform.MOBILE_ANDROID)
	@Locate(xpath = "\t\n"
			+ "//XCUIElementTypeButton[@name=\"Add to Order\"]/../XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeStaticText[last()]", on = Platform.MOBILE_IOS)
	protected Text costText;

	@Locate(xpath = "//android.widget.TextView[starts-with(@text,'Shot Options')]", on = Platform.MOBILE_ANDROID)
	@Locate(iOSClassChain = "**/XCUIElementTypeStaticText[`label == \"Shot Options\"`]", on = Platform.MOBILE_IOS)
	protected Button selectShotOptionsButton;

	@Locate(xpath = "//android.widget.TextView[starts-with(@text,'Warming')]", on = Platform.MOBILE_ANDROID)
	@Locate(iOSClassChain = "**/XCUIElementTypeStaticText[`label == \"Warming\"`]", on = Platform.MOBILE_IOS)
	protected Button warmingButton;

	@Locate(xpath = "//android.widget.TextView[starts-with(@text,'Oatmeal Toppings')]", on = Platform.MOBILE_ANDROID)
	@Locate(iOSClassChain = "**/XCUIElementTypeStaticText[`label == \"Oatmeal Toppings\"`]", on = Platform.MOBILE_IOS)
	protected Button oatmealToppingsButton;

	@Locate(xpath = "//android.widget.TextView[starts-with(@text,'Add Cream Cheese')]", on = Platform.MOBILE_ANDROID)
	@Locate(iOSClassChain = "**/XCUIElementTypeStaticText[`label == \"Add Cream Cheese\"`]", on = Platform.MOBILE_IOS)
	protected Button addCreamCheeseButton;

	@Locate(xpath = "//android.widget.TextView[starts-with(@text,'Add Toppings') or starts-with(@text,'Toppings')]", on = Platform.MOBILE_ANDROID)
	@Locate(iOSClassChain = "**/XCUIElementTypeStaticText[`label == \"Add Toppings\"`]", on = Platform.MOBILE_IOS)
	protected Button selectToppingsButton;

	@Locate(xpath = "//android.widget.TextView[starts-with(@text,'Sweeteners')]", on = Platform.MOBILE_ANDROID)
	@Locate(iOSClassChain = "**/XCUIElementTypeStaticText[`label CONTAINS \"Sweeteners\"`]", on = Platform.MOBILE_IOS)
	protected Button selectSweetenersButton;

	@Locate(xpath = "//android.widget.RelativeLayout[@resource-id='com.wearehathway.peets.development:id/quantity']//android.widget.ImageButton[@resource-id='com.wearehathway.peets.development:id/increaseQuantity']", on = Platform.MOBILE_ANDROID)
	@Locate(xpath = "//XCUIElementTypeStaticText[@name=\"Quantity\"]/../XCUIElementTypeButton[@name=\"+\"]", on = Platform.MOBILE_IOS)
	protected Button increaseQuantityButton;

	@Locate(xpath = "//android.widget.RelativeLayout[@resource-id='com.wearehathway.peets.development:id/quantity']//android.widget.TextView[@resource-id='com.wearehathway.peets.development:id/productQuantity']", on = Platform.MOBILE_ANDROID)
	@Locate(xpath = "//XCUIElementTypeStaticText[@name=\"Quantity\"]/following-sibling::XCUIElementTypeStaticText", on = Platform.MOBILE_IOS)
	protected Text quantityText;

	@Locate(xpath = "//android.widget.Button[@resource-id='com.wearehathway.peets.development:id/modifierButton' and @selected='true']", on = Platform.MOBILE_ANDROID)
	protected Button defaultSizeButton;

	@Locate(xpath = "//android.widget.TextView[starts-with(@text,'%s') and @resource-id='com.wearehathway.peets.development:id/categoryNameTextView']/following-sibling::android.widget.TextView[@resource-id='com.wearehathway.peets.development:id/categorySelectionsTextView']", on = Platform.MOBILE_ANDROID)
	...
	public ToppingsView selectToppings() {
		...
		if (selectToppingsButton.exists() && selectToppingsButton.isDisplayed()) {
			...
			while (attempt-- > 0 && !(selectToppingsButton.exists() && selectToppingsButton.isDisplayed())) {
