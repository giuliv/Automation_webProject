...
public class CreateAccountView extends BaseComponent {
	...
	@Locate(xpath = "//XCUIElementTypeStaticText[@name=\"Intended for users 13+ years old. Plus, get a birthday drink on us!\"]", on = Platform.MOBILE_IOS)
	@Locate(xpath = "//android.widget.TextView[@text='Your birthday drink is on us']", on = Platform.MOBILE_ANDROID)
	...
	@Locate(xpath = "//XCUIElementTypeScrollView/XCUIElementTypeOther/XCUIElementTypeOther[8]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeImage/following-sibling::XCUIElementTypeStaticText", on = Platform.MOBILE_IOS)
	@Locate(xpath = "//android.widget.TextView[contains(@resource-id,'id/passwordRule')]", on = Platform.MOBILE_ANDROID)
	protected List<Text> getPasswordHintTextBox;

	@Locate(xpath = "//XCUIElementTypeStaticText[@name='Enter your promo code here for special offers.']", on = Platform.MOBILE_IOS)
	@Locate(xpath = "//android.widget.TextView[@text='Enter your promo code here for special offers.']", on = Platform.MOBILE_ANDROID)
	...
	@Locate(iOSClassChain = "**/XCUIElementTypeButton[`name CONTAINS \"Yes, please send me emails with exclusive offers, rewards, news, and more.\"`]", on = Platform.MOBILE_IOS)
	...
	@Locate(iOSClassChain = "**/XCUIElementTypeButton[`name CONTAINS \"I agree to the\"`]", on = Platform.MOBILE_IOS)
	...
	@Locate(xpath = "//XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[@width='45']", on = Platform.MOBILE_IOS)
	...
	public boolean isPrivacyPolicyAndTermsAndConditionsChecked() {
		...
		SdkHelper.getDeviceControl().swipeAcrossScreenWithDirection(SwipeDirection.UP);
		SdkHelper.getSyncHelper().sleep(1000);
		return MobileHelper.isIosCheckboxChecked(getAgreePrivacyPolicyAndTermsAndConditions.getMobileElement());
	}
	...
	public boolean isPasswordTextDisplayed() {
		...
		boolean result = getPasswordHintTextBox.stream().map(item -> item.getText()).collect(Collectors.joining("\n"))
