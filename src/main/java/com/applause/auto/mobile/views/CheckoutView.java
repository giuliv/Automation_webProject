...
public class CheckoutView extends BaseComponent {
  ...
  @Locate(
      xpath =
          "//XCUIElementTypeOther[@name='Your Order']/following-sibling::XCUIElementTypeCell/XCUIElementTypeStaticText[contains(@name,'$')]//XCUIElementTypeOther/XCUIElementTypeImage/XCUIElementTypeImage",
