...
public class LegalInfoView extends BaseComponent {
	...
	@Locate(iOSClassChain = "**/XCUIElementTypeNavigationBar[`name == \"LEGAL INFO\"`]/XCUIElementTypeStaticText", on = Platform.MOBILE_IOS)
	...
	@Locate(iOSClassChain = "**/XCUIElementTypeNavigationBar[`name == \"LEGAL INFO\"`]/XCUIElementTypeButton", on = Platform.MOBILE_IOS)
