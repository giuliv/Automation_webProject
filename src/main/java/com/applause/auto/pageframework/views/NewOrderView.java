...
@IosImplementation(IosNewOrderView.class)
public class NewOrderView extends AbstractDeviceView {
    ...
    @MobileElementLocator(android = "com.wearehathway.peets.development:id/basketFABContainer", iOS = "//XCUIElementTypeImage[@name=\"Basket\"]/..")
    protected Button getCartButton() {
        return new Button(getLocator(this, "getCartButton"));
    }

    @MobileElementLocator(android = "com.wearehathway.peets.development:id/confirmButton", iOS = "Menu")
    protected Button getConfirmStoreButton() {
        return new Button(getLocator(this, "getConfirmStoreButton"));
    }
    ...
    public CheckoutView checkout() {
        ...
        getCartButton().pressButton();
        getConfirmStoreButton().pressButton();
        return DeviceViewFactory.create(CheckoutView.class);
    }
}
