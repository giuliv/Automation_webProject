...
public class MyAccountPage extends AbstractPage {
	...
	protected Text getSubscriptionsSection() { return new Text(this, getLocator(this, "getSubscriptionsSection")); }

	@WebElementLocator(webDesktop = "#peets-dashboard-subscription > div.box-head > a")
	protected Link getSubscriptionsManageLink() { return new Link(this, getLocator(this, "getSubscriptionsManageLink")); }

	@WebElementLocator(webDesktop = "//a[text()='Edit']")
	protected Button getSubscriptionsEditButton() { return new Button(this, getLocator(this, "getSubscriptionsEditButton")); }

	@WebElementLocator(webDesktop = "div#cutsomer-dashboard-recent-orders.box-account.box-recent.peets-account-block")
	protected Text getOrderHistorySection() { return new Text(this, getLocator(this, "getOrderHistorySection")); }

	@WebElementLocator(webDesktop = "#cutsomer-dashboard-recent-orders > div.box-head > a")
	protected Link getViewAllOrdersLink() { return new Link(this, getLocator(this, "getViewAllOrdersLink")); }

	@WebElementLocator(webDesktop = "td.review-col")
	protected Button getOrderRatingButton() { return new Button(this, getLocator(this, "getOrderRatingButton")); }

	@WebElementLocator(webDesktop = "div#customer-dashboard-payments.box-account.box-recent.peets-account-block")
	protected Text getPaymentSection() { return new Text(this, getLocator(this, "getPaymentSection")); }

	@WebElementLocator(webDesktop = "#customer-dashboard-payments > div.box-head > a")
	protected Link getPaymentManageCardsLink() { return new Link(this, getLocator(this, "getPaymentManageCardsLink")); }

	@WebElementLocator(webDesktop = "div.details")
	protected Image getPaymentDetailsImage() { return new Image(this, getLocator(this, "getPaymentDetailsImage")); }

	@WebElementLocator(webDesktop = "div#customer-dashboard-peets-cards.box-account.box-recent.peets-account-block")
	protected Text getPeetsCardSection() { return new Text(this, getLocator(this, "getPeetsCardSection")); }

	@WebElementLocator(webDesktop = "#customer-dashboard-peets-cards > div.box-head > a")
	protected Link getPeetsCardManageCardsLink() { return new Link(this, getLocator(this, "getPeetsCardManageCardsLink")); }

	@WebElementLocator(webDesktop = "div#customer-dashboard-settings.box-account")
	protected Text getSettingsSection() { return new Text(this, getLocator(this, "getSettingsSection")); }

	@WebElementLocator(webDesktop = "#customer-dashboard-settings > div.box-head > a")
	protected Link getGoToAddressBookLink() { return new Link(this, getLocator(this, "getGoToAddressBookLink")); }

	@WebElementLocator(webDesktop = "#customer-dashboard-settings > div.box-content > div > div:nth-child(2)")
	protected Text getBillingAddressSection() { return new Text(this, getLocator(this, "getBillingAddressSection")); }

	@WebElementLocator(webDesktop = "#customer-dashboard-settings > div.box-content > div > div:nth-child(2) > div.head-block > a")
	protected Link getBillingAddressEditLink() { return new Link(this, getLocator(this, "getBillingAddressEditLink")); }

	@WebElementLocator(webDesktop = "#customer-dashboard-settings > div.box-content > div > div:nth-child(3)")
	protected Text getShippingAddressSection() { return new Text(this, getLocator(this, "getShippingAddressSection")); }
