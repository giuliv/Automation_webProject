...
public class AssociateNewCardPage extends AbstractPage {
    ...
    protected EditField getCardNumberField() { return new EditField(this, getLocator(this, "getCardNumberField")); }

    @WebElementLocator(webDesktop = "#pin_number")
    protected EditField getPinNumberField() { return new EditField(this, getLocator(this, "getPinNumberField")); }

    @WebElementLocator(webDesktop = "button.btn-dark")
    protected Button getAssociateCardButton() { return new Button(this, getLocator(this, "getAssociateCardButton")); }
}
