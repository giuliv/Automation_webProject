...
public class PaymentMethodsPage extends AbstractPage {
    ...
    protected Button getAddACreditCardButton() { return new Button(this, getLocator(this, "getAddACreditCardButton")); }

    @WebElementLocator(webDesktop = "//a[text()='Add a PayPal account']")
    protected Button getAddAPaypalAccountButton() { return new Button(this, getLocator(this, "getAddAPaypalAccountButton")); }

    @WebElementLocator(webDesktop = "div.col-main > div > div.payment-card-holder.account-container > div.title > div > a:nth-child(3)")
    protected Button getAddPeetsCardButton() { return new Button(this, getLocator(this, "getAddPeetsCardButton")); }
    ...
    protected Button getEditCreditCardButton() { return new Button(this, getLocator(this, "getEditCreditCardButton")); }
    ...
    protected Text getSuccessfulDeleteText() { return new Text(this, getLocator(this, "getSuccessfulDeleteText")); }
}
