...
public class EditAccountInformationPage extends AbstractPage {
    ...
    protected EditField getFirstNameField() { return new EditField(this, getLocator(this, "getFirstNameField")); }
    ...
    protected Button getSaveButton() { return new Button(this, getLocator(this, "getSaveButton")); }

    @WebElementLocator(webDesktop = "#current_password")
    protected EditField getCurrentPasswordField() { return new EditField(this, getLocator(this, "getCurrentPasswordField")); }
}
