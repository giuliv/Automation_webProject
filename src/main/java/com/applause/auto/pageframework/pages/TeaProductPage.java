...
@WebDesktopImplementation(TeaProductPage.class)
@WebTabletImplementation(TeaProductPage.class)
@WebPhoneImplementation(TeaProductPage.class)
public class TeaProductPage extends AbstractPage {
