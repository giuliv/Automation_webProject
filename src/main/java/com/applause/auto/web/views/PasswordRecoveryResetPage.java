...
public class PasswordRecoveryResetPage extends BaseComponent {
  ...
  @Locate(
      xpath = "//p[text()='We found some errors. Please review the form and make corrections.']",
      on = Platform.WEB)
  private Text passwordMismatchErrorText;

  @Locate(
      xpath =
          "//p[text()='Password requirements were not met. Password requirements: at least 6 characters, a lowercase letter, a number.']",
      on = Platform.WEB)
